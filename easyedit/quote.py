...
beginning of a sentence and end at the end of a sentence. Skip narrator/trailer voiceover, YouTube
intros and garbled text.
...
def _extend(words: list[dict], s: int, e: int) -> tuple[int, int]:
    """Grow a too-short pick by whole sentences (forward first, then backward)."""
    def span(a, b):
